...
| :--- | :--- | :--- |  
| **1. Initial** | Heroic Efforts | Logic scattered in controllers; heavy use of "Fat Models." |  
| **2. Managed** | Project Discipline | Basic association discipline; Database constraints are enforced. |  
| **3. Defined** | Standardization | Service Objects and Query Objects become the standard protocol. |  
| **4. Quantitatively Managed** | Predictability | Performance metrics for N+1 queries; strict memory usage limits. |  
